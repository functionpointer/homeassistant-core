...
GatewayId = str
"""unique_id generated by config_flow.py and stored in the ConfigEntry as the unique id.
...
SUPPORTED_PLATFORMS_WITH_ENTRY_SUPPORT = set(FLAT_PLATFORM_TYPES.keys()) - set("notify")
